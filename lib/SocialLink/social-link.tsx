...
export const SocialLink = ({
    ...
    switch (social) {
      case "Instagram":
        return (
          <svg
            className={`
              ${small ? "w-3 h-3" : large ? "w-5 h-5" : "w-4 h-4"}
            `}
            aria-hidden="true"
  ...
  return (
    <a
      ...
      target="_blank"
      className={`text-center bg-transparent scale-100 text-basis dark:text-inverted hover:scale-110 transition-transform ease-in-out duration-300
